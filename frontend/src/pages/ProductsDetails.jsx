...
function ProductsDetails() {
  ...
  return productData ? (
    <div>
      <div className="w-[99vw]  md:h-[100vh] h-[130vh] flex items-center justify-start bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[20px] pt-[80px] lg:flex-row flex-col">
        <div className="lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row">
          ...
          <div className="lg:w-[60%] w-[50%] lg:h-[80%] h-[60%] border-[1px] border-[#80808049] rounded-md overflow-hidden">
            <img
              src={image}
              alt=""
        ...
        <div className="lg:w-[50vw] w-[100vw] lg:h-[75vh] h-[40vh] lg:mt-[80px] flex items-start justify-start flex-col py-[20px] px-[30px] md:pb-[20px] md:pl-[20px] lg:pl-[0px] lg:px-[0px] lg:py-[0px] gap-[10px]">
          ...
          <div className="flex items-center gap-1">
            <LiaStarSolid className="text-[20px] fill-[#FFD700]" />
            <LiaStarSolid className="text-[20px] fill-[#FFD700]" />
            <LiaStarSolid className="text-[20px] fill-[#FFD700]" />
            <LiaStarSolid className="text-[20px] fill-[#FFD700]" />
          ...
          <div className="w-[80%] h-[1px] bg-slate-700"></div>
          <div className="w-[80%] text-[20px] mt-[20px] text-white">
            <p>100% Original Product.</p>
            <p>Cash on delivery is available on this product</p>
            <p>East return and exchange policy with 7 days</p>
          </div>
        </div>
      </div>
      <div className="w-[100%] min-h-[70vh]  pt-[80px]  bg-gradient-to-l   from-[#141414] to-[#0c2025] flex items-start justify-start flex-col overflow-x-hidden ">
        <div className="flex px-[20px] mt-[20px] lg:ml-[80px] ml-[0px] lg:mt-[0px] md:mt-[50px]">
        ...
        <div className="w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px] md:px-[30px] lg:ml-[100px] ml-[20px] ">
          <p className="w-[95%] h-[90%] flex items-center">
            Upgrade your wardrode with this stylish slim-fit cotton shirt ,
            ...
            maintain and perfect for any setting, this is a must-have essential
        ...
        <RelatedProduct
          ...
          currrentProductId={productData._id}
        />
      </div>
    </div>
  ) : (
