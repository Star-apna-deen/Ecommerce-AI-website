...
function Cart() {
  ...
  return (
    <div className="w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] p-[20px] overflow-hidden">
      ...
      <div className="w-[100%] h-[92%] flex flex-wrap-[20px]">
              ...
              <div className="w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative">
                ...
                <div className="flex item-start justify-center flex-col gap-[10px]">
                  ...
                  <div className="flex items-center gap-[20px]">
                    <p className="text-[20px] text-[#aaf4ef]">
                  ...
                  onChange={(e) =>
                    e.target.value === " " || e.target.value === "0"
                      ...
                      : updateQuantity(
                          item._id,
                          item.size,
                          Number(e.target.value) //hamare pass jo value aa rahi h wo string me h use number me convert ker rahe h
                        )
                  }
                />
                <RiDeleteBin6Line
                  className="text-[#9ff9f9] w-[25px] h-[25px] absolute top-[15px] md:top-[40%] md:right-1 right-1"
