...
function Collection() {
  ...
  const toggleSubCategory = (e) => {
    //ager mene men select kiya h to men wale cloth aaye
    if (subCategory.includes(e.target.value)) {
      setSubCategory((prev) => prev.filter((item) => item !== e.target.value));
    } else {
      //werna sare product aa jaye
  ...
  return (
    <div className="w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex item-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2] pb-[110px]">
      <div
        className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh] ${
          showFilter ? "h-[55vh]" : "h-[8vh]"
