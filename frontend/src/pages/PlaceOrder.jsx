...
function PlaceOrder() {
  ...
  const initPay = (order) => {
    //data dalne ke liye ek window open hogi
    const options = {
      ...
      handler: async (response) => {
        ...
        console.log("helo rezorpay");
        if (data) {
          navigate("/order");
          setCartItem({}); //order hone ke baad use empty ker do
        }
      },
    };
    ...
    <div className="w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center flex-col md:flex-row gap-[50px] relative">
      <div className="lg:w-[50%] w-[100%] h-[100%] flex items-center justify-center lg:mt-[0px] mt-[90px]">
        ...
        >
          ...
          <div className="w-[100%] h-[70px] flex items-center justify-between px-[20px] ">
            <input
              type="text"
          ...
          <div>
            <button
              type="submit"
              className="text-[18px] active:bg-slate-500 cursor-pointer bg-[#3bcee848] py-[10px] px-[50px] rounded-2xl text-white flex items-center justify-center gap-[10px] absolute lg:right-[20%] bottom-[10%] right-[35%] border-[1px] border-[#80808049] ml-[30px] mt-[20px]"
            >
              PLACE ORDER
            </button>
          </div>
        ...
        <div className="lg:w-[70%] w-[90%] lg:h-[70%] h-[100%] flex items-center justify-center gap-[10px] flex-col">
          ...
          <div className="w-[100%] h-[30vh] lg:h-[100px] flex items-start mt-[20px] lg:mt-[0px] justify-center gap-[50px]">
            <button
              ...
              className={`w-[120px] h-[50px] rounded-sm ${
                method === "razorpay"
            ...
            >
              <img
                src={razorpay}
                className="w-[100%] object-fill rounded-sm"
                alt=""
              />
            </button>
