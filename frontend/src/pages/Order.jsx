...
const Order = () => {
  ...
  let { curreency } = useContext(ShopDataContext);
  let { serverUrl } = useContext(AuthDataContext);

  const loadOrderData = async () => {
    try {
      const result = await axios.post(
        serverUrl + "/api/order/userorder", //post request ker rahe h isliye empty string liya h
        {},
  ...
  return (
    <div className="w-[99vw] min-h-[100vh] p-[20px] pd-[150px] overflow-hidden bg-gradient-to-l from-[#141414] to-[#0c2025]">
            ...
            <div className="w-[100%] h-[80%] flex items-start gap-6 bg-[#51808048] py-[10px] px-[20px] rounded-2xl relative">
              ...
              <div className="flex items-start justify-center flex-col gap-[5px]">
                ...
                <div className="flex items-center gap-[8px] md:gap-[20px]">
                  <p className="md:text-[18px] text-[12px] text-[#aaf4c7]">
                    {curreency}
                    {item.price}
                  </p>
                  <p className="md:text-[18px] text-[12px] text-[#aaf4c7]">
                ...
                <div className="flex items-center">
                  <p className="md:text-[16px] text-[12px] text-[#e4fbff]  ">
                    Date:
                    <span className="pl-[10px] text-[#e4fbff] md:text-[16px] text-[11px]">
                ...
                <div className="absolute md:left-[55%] md:top-[40%] right-[2%] top-[2%] ">
                  ...
                  <div className="absolute md:right-[5%] right-[1%] md:top-[40%] top-[70%]">
                    <button
                      className="md:px-[15px] md:py-[7px] px-[5px] py-[3px] rounded-md bg-[#101919] text-[#f3f9fc] text-[12px] md:text-[16px] cursor-pointer active:bg-slate-500"
