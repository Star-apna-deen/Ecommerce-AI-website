...
function Add() {
  ...
  const handleAddProduct = async (e) => {
    ...
    try {
      ...
      toast.success("ProductAdd Successfully");
      setLoading(false);
      ...
      console.log(error);
      setLoading(false);
      toast.success(" ProductAdd Failed");
    }
  };
  ...
  return (
    <div className="w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white overflow-x-hidden relative">
      ...
      <div className="w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute right-0 bottom-[5%]">
        ...
        >
          <div className="w-[400px] h-[50px] text-[25px] md:text-[40px] text-whites mt-15">
            Add Product Page
          </div>
            ...
            <div className="w-[100%] h-[100%] flex items-center justify-start">
              ...
              >
                <img
                  ...
                  alt=""
                  className="w-[80%] h-[80%] rounded-lg shadow-2xl hover:border-[#1d1d1d] border-1"
                />
                <input
                  type="file"
                  id="image1"
          ...
          <div className="w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px]">
            ...
            <input
              ...
              className="w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-2 cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2]"
          ...
          <div className="w-[80%]  flex items-start justify-center flex-col gap-[10px]">
            ...
            <textarea
              type="text"
              placeholder="Tyep here"
              className="w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7] border-2 cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2] py-[10px]"
          ...
          <div className="w-[80%] flex items-center gap-[15px] flex-wrap">
            <div className="md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]">
              ...
              <select
                name=""
                id=""
                className="bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-2"
          ...
          <button className="w-[140px] px-4 py-5 rounded-xl bg-[#3dc0e4] flex items-center justify-center gap-[10px] text-black  active:bg-slate-700 active:text-white active:border-[2px] border-white">
